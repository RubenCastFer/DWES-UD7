<?php
    function formulario() {
        ...
        if (isset($_POST['enviar'])) {
            $url = "http://localhost/DWES/EJERCICIO_DE_CLASE/DWES-UD7/ejercicio4Servidor/index.php?controller=ciudades&action=ciudadesServidor";
            $uri = "http://localhost/DWES/DWES-UD7/";
